...
const mock = (response: AxiosResponse) => {
  if (
    true ||
    (location.hostname !== 'localhost' && location.hostname !== '127.0.0.1' && location.hostname !== '192.168.1.3')
  ) {
    return false
  }
...
export const http = new HttpClient(isDev() ? 'api/v1' : 'http://121.196.236.94:3000/api/v1')
